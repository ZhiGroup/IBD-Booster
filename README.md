# IBD-Booster
Fast IBD segment detection from phased VCF files using PBWT, integrating P-smoother error correction and seed-and-extend IBD calling following Browning et al. (hap-IBD), implemented in C++.
## Building
